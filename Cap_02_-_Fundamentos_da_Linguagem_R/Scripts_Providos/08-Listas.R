...
setwd("C:/Users/Renan/Desktop/Formacao_Cientista_de_Dados_DSA/Cap_02_-_Fundamentos_da_Linguagem_R/Scripts_Providos")
getwd()
...
lista_caracter2
lista_caracter3 = list(matrix(c("A", "A", "C", "A"), nr = 2), 'B', 'C')
